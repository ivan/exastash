...
SELECT throws_ilike('cannot_insert_without_cipher_key', '%violates not-null constraint%');
...
SELECT throws_ilike('cannot_insert_wrong_cipher_key_size_15', '%violates check constraint%');
...
SELECT throws_ilike('cannot_insert_wrong_cipher_key_size_17', '%violates check constraint%');
