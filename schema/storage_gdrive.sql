...
-- Some of the columns are ordered strangely here so that they are packed optimally:
-- https://www.2ndquadrant.com/en/blog/on-rocks-and-sand/
-- Use SELECT pg_column_size(row(somevalue::sometype, ...)) to measure storage bytes for a row.
CREATE TABLE gdrive_files (
    ...
    -- not signed, just using int as a 32-bit field instead of bytea to save one byte
    crc32c       int          NOT NULL,
